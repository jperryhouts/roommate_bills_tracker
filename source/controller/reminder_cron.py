...
if __name__ == '__main__':
    settings = json.load(open(srcdir+'/model/settings.json'))
    ledger = Ledger(srcdir+'/model/ledger.db', settings['roommate_names'])
...
<html>
  ...
  <body>
    ...
    '''.format(css=open(srcdir+'/view/style/styles.css','r').read(), \
               uri=settings['URI'], \
